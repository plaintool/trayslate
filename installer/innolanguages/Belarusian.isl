...
DownloadingLabel2=Спампоўванне дадатковых файлаў...
...
ExtractingLabel=Распакоўка дадатковых файлаў...
ButtonStopExtraction=&Спыніць распакоўку
StopExtraction=Вы сапраўды хочаце спыніць распакоўку?
ErrorExtractionAborted=Распакоўка перарвана
ErrorExtractionFailed=Збой распакоўкі: %1

; *** Archive extraction failure details
ArchiveIncorrectPassword=Няправільны пароль
ArchiveIsCorrupted=Архіў пашкоджаны
ArchiveUnsupportedFormat=Фармат архіва не падтрымліваецца
...
RetryCancelSelectAction=Выберыце дзеянне
RetryCancelRetry=&Паспрабаваць яшчэ раз
RetryCancelCancel=Скасаваць

; *** Installation status messages
StatusClosingApplications=Закрыццё праграм...
StatusCreateDirs=Стварэнне каталогаў...
StatusExtractFiles=Выманне файлаў...
StatusDownloadFiles=Спампоўванне файлаў...
...
ErrorFunctionFailed=%1 збой; нумар памылкі %2
ErrorFunctionFailedWithMessage=%1 збой; нумар памылкі %2.%n%3
...
SourceVerificationFailed=Збой праверкі зыходнага файла: %1
VerificationSignatureDoesntExist=Файл подпісу "%1" не існуе
VerificationSignatureInvalid=Файл подпісу "%1" несапраўдны
VerificationKeyNotFound=Файл подпісу "%1" выкарыстоўвае невядомы ключ
VerificationFileNameIncorrect=Няправільнае імя файла
VerificationFileTagIncorrect=Няправільная метка файла
VerificationFileSizeIncorrect=Няправільны памер файла
VerificationFileHashIncorrect=Няправільная хэш-сума файла
...
ErrorDownloading=Адбылася памылка пры спробе спампаваць файл:
ErrorExtracting=Адбылася памылка пры спробе распакаваць файл:
