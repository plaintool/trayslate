# Trayslate
Trayslate is a tray application for translating text. You can translate text from the clipboard or by typing it into the input window. The translation source is configurable, you can change the service used.
